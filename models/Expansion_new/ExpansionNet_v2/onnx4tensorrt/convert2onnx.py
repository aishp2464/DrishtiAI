...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_path_1', type=str, default='./demo_material/bear.jpeg')
    parser.add_argument('--image_path_2', type=str, default='./demo_material/micheal.jpg')
    parser.add_argument('--load_model_path', type=str, default='../model_files/rf_model.pth')
    parser.add_argument('--output_onnx_path', type=str, default='../model_files/model.onnx')
